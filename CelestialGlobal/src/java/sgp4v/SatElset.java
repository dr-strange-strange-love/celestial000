...
//  private DecimalFormat dfdot8 = new DecimalFormat(".00000000");
    ...
    public SatElset(String name, String card1, String card2)
        ...
        int noradIDCard1 = Integer.parseInt(card1.substring(2, 6));
        int noradIDCard2 = Integer.parseInt(card2.substring(2, 6));
        if (noradIDCard1 != noradIDCard2) throw new SatElsetException("Norads on cards don't match");
